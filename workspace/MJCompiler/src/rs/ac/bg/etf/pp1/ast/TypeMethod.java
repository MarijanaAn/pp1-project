...
public class TypeMethod extends MethodDecl {
    ...
    public TypeMethod (MethodTypeName MethodTypeName, FormParams FormParams, VarDeclList VarDeclList, StatementList StatementList) {
